  ...
  },
  {
    ...
    data: {
      allDimensions: {
        ...
        sv: 'Katso [tästä](https://teaching.helsinki.fi/ohjeet/artikkeli/mooc-kurssien-kriteerit-ja-ohjeet) MOOC-kurssien kriteerit ja ohjeet.',
        en: 'Katso [tästä](https://teaching.helsinki.fi/ohjeet/artikkeli/mooc-kurssien-kriteerit-ja-ohjeet) MOOC-kurssien kriteerit ja ohjeet.',
      },
      investication: {
        fi: '',
        sv: '',
  ...
  },
  {
    ...
    data: {
      allDimensions: {
        ...
        sv: 'Mikäli kurssin osallistujamäärää ei ole rajattu, voisi kurssin todennäköisesti järjestää myös MOOC-kurssina. Katso [tästä](https://teaching.helsinki.fi/ohjeet/artikkeli/mooc-kurssien-kriteerit-ja-ohjeet) MOOC-kurssien kriteerit ja ohjeet.',
        en: 'Mikäli kurssin osallistujamäärää ei ole rajattu, voisi kurssin todennäköisesti järjestää myös MOOC-kurssina. Katso [tästä](https://teaching.helsinki.fi/ohjeet/artikkeli/mooc-kurssien-kriteerit-ja-ohjeet) MOOC-kurssien kriteerit ja ohjeet.',
      },
      investication: {
        fi: '',
        sv: '',
  ...
  },
  {
    ...
    data: {
      allDimensions: {
        ...
        sv: 'Lähiopetuksessa [opetukseen käytettävät tilat](https://teaching.helsinki.fi/ohjeet/artikkeli/opetuksessa-kaytettavat-tilat) voivat mahdollistaa erilaisten digitaalitsen työvälineiden käytön opetuksen ja oppimisen tukena.',
  ...
  },
  {
    ...
    data: {
      allDimensions: {
        ...
        sv: 'Etäopetus mahdollistaa suurten opiskelijamäärien osallistumisen joustavasti, mutta vaatii [huolellista opetuksen ja oppimisprosessin suunnittelua.](https://teaching.helsinki.fi/ohjeet/artikkeli/opetuksessa-kaytettavat-tilat#paragraph-5422) Opiskelijoiden työskentely on ohjeistettava tarkasti, aktiivisuuden ylläpitoon on panostettava, ohjauksen ja vuorovaikutuksen toteuttaminen edellyttää [käytettävien välineiden hyvää tuntemusta](https://teaching.helsinki.fi/ohjeet/artikkeli/opetuksessa-kaytettavat-tilat#paragraph-5422) ja oppimistehtävissä on huomioitava etäopiskelijoiden "näkymättömyys" opettajalle. Etäopiskelu voidaan järjestää ryhmän koosta riippuen itseopiskelua tai yhteisöllistä työskentelyä painottaen.',
  ...
  },
  {
    ...
    data: {
      allDimensions: {
        ...
        sv: '[Tentin](https://teaching.helsinki.fi/ohjeet/artikkeli/tentit-ja-niiden-jarjestaminen) voi järjestää joko tiettynä päivänä tai pidemmän tenttiperiodin aikana, yliopiston sähköisen tenttimisen tiloissa, etä- tai salitenttinä. Tentti on yksi tapa arvioida opiskelijan osaamista ja miten kurssin oppimistavoitteet on saavutettu. Välitentit ja -testit ovat myös hyvä keino tukea opiskelijan oppimista kurssin aikana.',
        en: '[Tentin](https://teaching.helsinki.fi/ohjeet/artikkeli/tentit-ja-niiden-jarjestaminen) voi järjestää joko tiettynä päivänä tai pidemmän tenttiperiodin aikana, yliopiston sähköisen tenttimisen tiloissa, etä- tai salitenttinä. Tentti on yksi tapa arvioida opiskelijan osaamista ja miten kurssin oppimistavoitteet on saavutettu. Välitentit ja -testit ovat myös hyvä keino tukea opiskelijan oppimista kurssin aikana.',
      },
      investication: {
        fi: '',
        sv: '',
  ...
  },
  {
    ...
    data: {
      allDimensions: {
        ...
        sv: '[Ryhmätyöt](https://teaching.helsinki.fi/ohjeet/artikkeli/erilaisia-arviointitapoja#paragraph-6551) perustuvat yhdessä tekemiseen ja keskusteluun. Ryhmätyöt edistävät opiskelijoiden välistä vuorovaikutusta ja opettavat yhteistyötaitoja. Opiskelijoiden väliset keskustelut ja tehtävien tekeminen yhdessä syventävät aiheen ymmärrystä.',
        en: '[Ryhmätyöt](https://teaching.helsinki.fi/ohjeet/artikkeli/erilaisia-arviointitapoja#paragraph-6551) perustuvat yhdessä tekemiseen ja keskusteluun. Ryhmätyöt edistävät opiskelijoiden välistä vuorovaikutusta ja opettavat yhteistyötaitoja. Opiskelijoiden väliset keskustelut ja tehtävien tekeminen yhdessä syventävät aiheen ymmärrystä.',
      },
      investication: {
        fi: '',
        sv: '',
